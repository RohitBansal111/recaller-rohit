  ...
  return (
    <div className="form-page-layout subscribe-pricing-list">
      ...
      <div className="subscribe-mbtn">
        <Button className={monthisActive ? 'active':null} onClick={monthlytoggleClass}>
           Monthly
        </Button>
        <Button className={annualisActive ? 'active': null} onClick={annualtoggleClass}>
        annual
        </Button>
      </div>
              ...
              <div className="card-header">
                <div className="price-heading">
                  ...
                  <div className="time-period">
                    <h6 className={monthisActive ? 'monthly active': 'monthly'}>
                      <sup>$</sup>149<small>/mo</small>
                    </h6>
                    <h6 className={annualisActive ? 'yearly active': 'yearly'}>
