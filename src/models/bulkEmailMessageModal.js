...
const BulkEmailMessageModal = ({ open, handleCloseMessageModal, ...props }) => {
      ...
      <div className="modal-body bulkms">
        <form className="main-form">
          <div className="field-group flexFull">
            <label>Select Campaign Email</label>
            <NewEmailSelectTag
          ...
          <div className="field-group messageBoxModal flexFull">
            ...
            <ul className="action-icons">
                ...
                >
                  ...
                  {props.templateData &&
                    props.templateData.map((item) => (
                      <li onClick={() => props.handleEmailTempTitleClick(item)}>
                        {item.title}
                      </li>
                    ))}
                  <button
              ...
              <span
                ...
                onClick={() => props.handleReSchaduleData(props.scheduledData)}
              >
                {props.scheduledData &&
                props.scheduledData.date &&
                props.scheduledData.time
                  ? `(${
                      props.scheduledData.date + " " + props.scheduledData.time
                    })`
                  : " "}
              </span>
            </ul>
          ...
          <div className="field-group flexFull text-center mt-3">
            ...
            <LoadingButton
              ...
              disabled={
                !props.emailMessage || props.selected.length == 0 ? true : false
              }
              onClick={props.handleSendBulkClick}
...
export default BulkEmailMessageModal;
